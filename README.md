...
<li>Joaquin Andree Pedraza Maldonado: <br> Durante el trabajo final, fomenté la colaboración dentro del equipo y contribuí activamente al desarrollo del backend, especialmente en la implementación y mejora del bounded context Postulations. Brindé apoyo a mis compañeros al resolver dudas técnicas y participé en sesiones grupales para asegurar la integración correcta de todas las funcionalidades desarrolladas.<br></li>
<li>Alessandra Nicole Becerra Tejeda: <br> En este trabajo final, participé activamente en las reuniones del equipo, coordinando tareas y asegurándome de que todos los aportes estuvieran alineados con los objetivos del proyecto. Contribuí a la mejora del flujo de información, brindando retroalimentación oportuna y colaborando en la validación de funcionalidades en el backend.<br></li>
<li>Andrea Elizabeth Santur Tello: <br> He participado de forma activa en la planificación y ejecución del trabajo final, desarrollando funcionalidades asignadas del backend, apoyando a mis compañeros en la integración con otras secciones y aportando ideas para mejorar el flujo del sistema. Además, participé en reuniones para coordinar tareas y brindar retroalimentación constructiva.<br></li>
<li>Pedro Jesús Nanfuñay Liza: <br> En el desarrollo del trabajo final, mantuve una comunicación activa con mis compañeros y participé en la implementación del bounded context Profile. Brindé apoyo técnico a quienes lo necesitaron, fomentando un ambiente de trabajo colaborativo y asegurando el cumplimiento de los objetivos establecidos para este entregable.<br></li>
<li>Diego Ivan Cabrera Buitron: <br> Durante esta entrega final, participé en reuniones de seguimiento para asegurar la correcta finalización del backend. Aporté ideas para la optimización de funcionalidades y colaboré con mis compañeros al brindar apoyo en la revisión del código y la integración entre módulos, promoviendo el trabajo en equipo.<br></li>
        </ul> 
      </td>
      ...
      <br><strong>TP</strong><p align="justify">Se planificó oralmente en equipo la creación de esta primera versión del front-end, proporcionando la productividad del equipo y comunicar de manera efectiva la importancia de nuestro producto.<br><strong>TB2</strong><p align="justify">Se planificó oralmente en equipo la creación de esta primera versión del front-end, proporcionando la productividad del equipo y comunicar de manera efectiva la importancia de nuestro producto.<br><strong>TF</strong><p align="justify">Se mantuvo una comunicación constante entre todos los integrantes del equipo, lo cual permitió coordinar eficazmente el desarrollo del backend. Se fomentó la participación activa en reuniones grupales, la colaboración en la integración de funcionalidades y el cumplimiento de los objetivos establecidos. Cada miembro asumió con responsabilidad sus tareas asignadas, brindando apoyo técnico y retroalimentación oportuna, lo que contribuyó al cierre exitoso del proyecto y al fortalecimiento del trabajo en equipo.
    </tr>
    <tr style="border-bottom: 1px solid black;">
...
diferentes rangos de audiencia</strong></td>
      <td style="border-right: 1px solid black;">
        <ul>
         ...
         <br>
          <p><strong>TF</strong></p>
           <li>Diego Ivan Cabrera Buitron: <br> Durante esta entrega final, participé activamente en las reuniones del grupo, liderando la integración del backend con el frontend. Supervisé el correcto funcionamiento del bounded context de Postulaciones y ayudé a documentar los detalles técnicos para el informe. Además, facilité revisiones cruzadas para asegurar la consistencia del producto final.<br> </li>
           <li>Alessandra Nicole Becerra Tejeda: <br>En esta última etapa del proyecto, estuve presente en todas las reuniones de equipo, facilitando el cierre de funcionalidades pendientes y la revisión de contenidos clave para el informe. También colaboré activamente en el desarrollo y validación de los casos de uso propuestos, asegurando que se alineen con las necesidades del usuario.
</li>
           <li>Andrea Elizabeth Santur Tello: <br> Para este entregable final, me involucré de manera constante en las reuniones grupales, dando seguimiento al cumplimiento de las tareas y reforzando la organización del equipo. Apoyé en la integración final del frontend, revisando la conexión con los servicios y validando que las funcionalidades desarrolladas cumplan con los requisitos establecidos.</li>
           <li>Nanfuñay Liza Pedro Jesús: <br> Contribuí en el trabajo final asistiendo a las sesiones grupales y asegurando la correcta integración de los módulos desarrollados. Me encargué de revisar y testear los componentes correspondientes al backend, y optimizando funcionalidades para garantizar una entrega de calidad.</li>
          <li>Joaquin Andree Pedraza Maldonado: <br> En esta entrega final, participé activamente en las reuniones grupales, proponiendo mejoras en la organización del equipo y asegurando que cada integrante cumpliera con sus tareas asignadas. Aporté en la validación final del sistema, ofreciendo retroalimentación y verificando que los criterios definidos por el equipo fueran correctamente implementados. </li>
        </ul>
      </td>
      <td><p><strong>TB1</strong></p><p align="justify">Cada miembro de nuestro equipo mostró disposición y estableció un entorno colaborativo a través de medios de comunicación efectivos, se establecieron reuniones, llamadas, entregas tempranas y constantes revisiones de cada capítulo de nuestro proyecto. Nos reunimos en periodos continuos para opinar y colaborar en cada proceso del desarrollo de nuestro producto y su documentación. Nos establecimos metas tempranas con la planificación de tareas y las mejoramos conjuntamente con la revisión de la calidad del proceso culminado.</p><br><strong>TP</strong></p><p align="justify">El presente equipó demostró comunicarse de manera efectiva y así, la productividad de este mismo incrementó considerablemente, contribuyendo a la creación de la primera versión del producto, demostrando la importancia de este mismo mediante la comunicación presente dentro del equipo. Se establecieron tareas designadas para cada integrante del equipo que se establecieron mediante la comunicación oral y escrita y que se trabajaron en su totalidad.</p><br><strong>TB2</strong></p><p align="justify">El presente equipó demostró desenvolverse con total capacidad y demostrar su eficacia en la comunicación entre nosotros mismos. Se establecieron tareas designadas y se cumplieron todas en el tiempo esperado. Se trabajó en conjunto para concluir de manera satisfactoria el presente trabajo.</p><br><strong>TF</strong></p><p align="justify"> En esta entrega final, el equipo demostró un alto nivel de coordinación y compromiso. Se realizaron reuniones regulares para distribuir equitativamente las tareas, dar seguimiento a los avances y resolver los pendientes de manera efectiva. La retroalimentación constante entre los miembros permitió mejorar tanto el código como la documentación del proyecto. Asimismo, se fomentó un ambiente colaborativo en el que todos participaron activamente en la integración final del sistema, asegurando una entrega sólida, bien estructurada y acorde a los objetivos planteados desde el inicio del proyecto.
  </tbody>
</table>
